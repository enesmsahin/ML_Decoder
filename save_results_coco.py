...
parser.add_argument('--pic-path', type=str, default='/media/mmrg/DATA/enes/data/COCO/coco_images')
...
parser.add_argument('--th', type=float, default=0.70)
...
parser.add_argument('--out-file', default="coco_test.tsv", type=str)
parser.add_argument('--img_id_file', default="/media/mmrg/DATA/enes/data/COCO/coco_caption/test.label.tsv", type=str)
parser.add_argument('--allowed_classes_file', type=str, default="/media/mmrg/DATA/enes/code/THESIS-CODE/open_images_class-descriptions-boxable_v5.csv", help="Open Images CSV File indicating boxable classes")
    ...
    with open(args.out_file, "w") as out_file:
        with open(args.img_id_file, "r") as img_id_file:
            for img_id in img_id_file:
                ...
                im_path = next(Path(args.pic_path).rglob(f"*{img_id}*.jpg"))
                try:
